...
public class Report9Adapter extends RecyclerView.Adapter<Report9Adapter.DataObjectHolder> {
    private ArrayList<Report9Model> mDataSet;
    Context context;


    public Report9Adapter(ArrayList<Report9Model> mDataSet, Context context) {
    ...
    @NonNull
    @Override
    public Report9Adapter.DataObjectHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_report9, parent, false);
    ...
    @Override
    public void onBindViewHolder(@NonNull final Report9Adapter.DataObjectHolder holder, int position) {

        final Report9Model hoursOfflineModel = mDataSet.get(position);
    ...
    private void showLogOutDialog(Report9Model report9Model) {
        ...
        alert_message.setText(String.format("%s\t\t%s\n\n%s\t\t%s",
                ...
                report9Model.getActiontype(),
                context.getString(R.string.notes),
                report9Model.getNotes()));
